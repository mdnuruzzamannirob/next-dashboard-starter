...
export function ResetPasswordForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="rounded-lg bg-gray-50 p-4" role="region" aria-label="Password requirements">
        ...
        <ul className="space-y-1 text-xs">
          ...
          <li className={requirements.number ? "text-green-600" : "text-gray-600"}>✓ One number</li>
